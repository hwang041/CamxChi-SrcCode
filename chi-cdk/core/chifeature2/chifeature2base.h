...
struct ChiFeature2CreateInputInfo
{
    ...
    union
    {
        struct
        {
            ...
            UINT32 reserved               : 29;  ///< reserved for future flags
        };
...
private:
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// HandleOutputErrorNotificationPending
    ///
    /// @brief  Handles notification of feature's output consumption in error case.
    ///         The request enters into consumer error notify pending state when the base has recieved all outputs during
    ///         error. This function will check if we can complete the request. It is separate from
    ///         HandleOutputNotificationPending in that the references are taken care of at the time that the error is set
    ///         in update target
    ///
    /// @param  pRequestObject  Feature request object.
    /// @param  requestId       requestId on which to operate
    ...
    /// @return CDKResultSuccess if successful or CDK error values in case of error.
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CDKResult HandleOutputErrorNotificationPending(
        ChiFeature2RequestObject* pRequestObject,
        UINT8                     requestId);
