...
protected:
    ...
    struct FRCRequest : public LightweightDoublyLinkedListNode
    {
        ...
        // For debugging
        UINT32          srcFrameNumber;     ///< The internal request number we assigned. We start counting
        ...
        UINT32          captureRequestNum;  ///< The capture request number received from the framework
