...
CHIAWBAlgorithm*         g_AWBLibAlgorithmIntf;
    ...
    AWBAlgoGetParam*    pGetParams)
{
    ...
    if (NULL != g_AWBLibAlgorithmIntf->AWBGetParam)
    {
        result = g_AWBLibAlgorithmIntf->AWBGetParam(g_AWBLibAlgorithmIntf, pGetParams);
    }
    ...
    const AWBAlgoSetParamList*  pSetParams)
{
    ...
    if (NULL != g_AWBLibAlgorithmIntf->AWBSetParam)
    {
        result = g_AWBLibAlgorithmIntf->AWBSetParam(g_AWBLibAlgorithmIntf, pSetParams);
    }
    ...
    const AWBAlgoDestroyParamList*   pDestroyParams)
{
    ...
    {
        if (NULL != g_AWBLibAlgorithmIntf->AWBDestroy)
        {
            g_AWBLibAlgorithmIntf->AWBDestroy(g_AWBLibAlgorithmIntf, pDestroyParams);
            g_AWBLibAlgorithmIntf = NULL;
        }
    }
}
    ...
    AWBAlgoOutputList*      pOutputs)
{
    ...
    if (NULL != g_AWBLibAlgorithmIntf->AWBProcess)
    {
        result = g_AWBLibAlgorithmIntf->AWBProcess(g_AWBLibAlgorithmIntf, pInputs, pOutputs);
    }
    ...
    CHIAWBAlgorithm**               ppAWBAlgorithm)
{
    ...
    if (pCreateParams->pCreateParams != NULL)
    {
        ...
        if (result == CDKResultSuccess)
        {
            ...
            g_AWBLibAlgorithmIntf = *ppAWBAlgorithm;
