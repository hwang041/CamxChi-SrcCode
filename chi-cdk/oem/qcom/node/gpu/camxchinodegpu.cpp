    ...
    CHINODEPROCESSREQUESTINFO* pProcessRequestInfo)
{
    ...
    else // Non-Bypass Case: Apply downscaling
    {
        ...
        if ((INVALID_INDEX != idxOutputDSb) && (INVALID_INDEX != idxOutputDS))
        {
    ...
    CHINODEPROCESSREQUESTINFO* pProcessRequestInfo)
{
    ...
    if (m_vendorTagPreviewStreamPresent != 0)
    {
        ...
        {
            LOG_VERBOSE(CamxLogGroupChi, "This is time to skip request %llu", (long long int)pProcessRequestInfo->frameNum);
