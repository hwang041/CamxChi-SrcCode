...
{
    { { 0, 1, 2, 3, 8 } ,{ SINGLE_CAMERA } },
    { { 4, 5, 6, 7 },    { MULTI_CAMERA } },
    { { 5 }, { BOKEH_CAMERA } },
    { { 4 }, { FUSION_CAMERA } },
};
        ...
        *pGraphDescriptorTables->pCameraIdDescriptorNameSet =
        {
            ...
            { SINGLE_CAMERA, { RTMFNRJPEGFeatureGraphDescriptor.pFeatureGraphName,
                               ...
                               RTMFNRYUVFeatureGraphDescriptor.pFeatureGraphName } },
        ...
        *pGraphDescriptorTables->pFeatureGraphDescriptorsMap =
        {
            ...
            { RTMFNRYUVFeatureGraphDescriptor.pFeatureGraphName,       RTMFNRYUVFeatureGraphDescriptor },
