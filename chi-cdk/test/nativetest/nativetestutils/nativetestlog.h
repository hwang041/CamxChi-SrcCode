...
// Define NativeChiTest App version
#define NATIVECHITEST_VERSION "Version 3.0.1"
#define NATIVEHALTEST_VERSION "Version 5.0.0"

namespace tests {

#ifndef __FILENAME__
#define __FILENAME__ OsUtils::GetFileName(__FILE__)
#endif
...
#define NT_LOG(logLevel, ...) if(logLevel >= NTLog.m_eLogLevel) { NTLog.Log( logLevel, ##__VA_ARGS__); }
