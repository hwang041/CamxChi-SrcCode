    ...
    ISPInputData* pInput)
{
        ...
        pInstanceProperty->processingType == IPEProcessingType::IPEMFSRBlend)
    {
        ...
        perspectiveConfidence = pInput->ICAConfigData.ICAInPerspectiveParams.perspectiveConfidence;
    }
    ...
    if (m_dependenceData.perspectiveConfidence != perspectiveConfidence)
    {
        ...
        CAMX_LOG_VERBOSE(CamxLogGroupIQMod, "%s: MCTF case: enable TransformConfidence %d",
