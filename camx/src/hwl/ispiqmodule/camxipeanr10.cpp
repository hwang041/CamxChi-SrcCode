    ...
    ISPInputData* pInputData)
{
    ...
    if (TRUE == m_validateANRSettings)
    {
        ValidateAndCorrectANRParams(pInputData);
    }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10::ValidateAndCorrectANRParams
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10::ValidateAndCorrectANRParams(
    const ISPInputData* pInputData)
{
    CamxResult result = CamxResultSuccess;
    ...
    if (TRUE == pInputData->pipelineIPEData.realtimeFlag)
    {
        ValidateAndCorrectPreviewsAndvideoParameters(pInputData);
    }
    else
    {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10::ValidateAndCorrectPreviewsAndvideoParameters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10::ValidateAndCorrectPreviewsAndvideoParameters(
    const ISPInputData* pInputData)
{
    CamxResult      result         = CamxResultSuccess;
    IpeIQSettings*  pIPEIQSettings = reinterpret_cast<IpeIQSettings*>(pInputData->pipelineIPEData.pIPEIQSettings);
    for (UINT32 pass = 0; pass < pInputData->pipelineIPEData.numPasses; pass++)
    {
        if (TRUE == pIPEIQSettings->anrParameters.parameters[pass].moduleCfg.EN)
        {
            if (PASS_NAME_FULL == pass)
            {
                ValidateAndSetParams(&pIPEIQSettings->anrParameters.parameters[pass].filter2Parameters.
                    filter2Bypass.CYLPF_FILTER2_BYPASS, pass, 1, "Preview/Video FIL2 Config");
                ValidateAndSetParams(&pIPEIQSettings->anrParameters.parameters[pass].rnfParameters.rnfBypass.
            ...
            {
                ValidateAndSetParams(&pIPEIQSettings->anrParameters.parameters[pass].filter2Parameters.
                    filter2Bypass.CYLPF_FILTER2_BYPASS, pass, 0, "Preview/Video FIL2 Config");
                ValidateAndSetParams(&pIPEIQSettings->anrParameters.parameters[pass].rnfParameters.rnfBypass.
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// IPEANR10::ValidateAndCorrectStillModeParameters
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CamxResult IPEANR10::ValidateAndCorrectStillModeParameters(
    const ISPInputData* pInputData)
{
