            ...
            if (PipelineType::IFE == pOutput->type)
            {
                ...
                if (NULL != pInput->pTintlessStats)
                {
                    ...
                    CAMX_LOG_INFO(CamxLogGroupISP, "IFE Store Tintless camera %d sensorAR %d"
                        ...
                        cameraID, sensorAR, pInput->bankSelect,
                        pOutput->pUnpackedField->mesh_table[0][0][0][0],
                        pOutput->pUnpackedField->mesh_table[0][1][0][0],
                        pOutput->pUnpackedField->mesh_table[0][2][0][0],
                        pOutput->pUnpackedField->mesh_table[0][3][0][0]);
                }
    ...
    LENR10OutputData*     pOutput)
{
    ...
    lenr_1_0_0::chromatix_lenr10_reserveType*               pReserveType       = NULL;
    lenr_1_0_0::chromatix_lenr10Type::enable_sectionStruct* pModuleEnable      = NULL;
    ISPHWSetting*                                           pHWSetting         = NULL;
        ...
        (NULL != pOutput) && (NULL != pInput->pInterpolationData))
    {
        ...
        if (NULL == pOEMIQData)
        {
            ...
            pReserveType = &(pInput->pChromatix->chromatix_lenr10_reserve);
            pModuleEnable = &(pInput->pChromatix->enable_section);
        }
        else
        {
            ...
            if (NULL != pInterpolationData)
            {
                ...
                pReserveType = reinterpret_cast<lenr_1_0_0::chromatix_lenr10_reserveType*>(
                    &(pOEMInput->LENRReserveType));
                pModuleEnable = reinterpret_cast<lenr_1_0_0::chromatix_lenr10Type::enable_sectionStruct*>(
