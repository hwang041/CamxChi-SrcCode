    ...
    if (NULL != pInputData)
    {
        ...
        if (CamxResultSuccess == result)
        {
            ...
            result = IQInterface::BPSLinearization34CalculateSetting(&m_dependenceData,
                                                                     ...
                                                                     &outputData);
            pInputData->pCalculatedMetadata->stretchGainBlue      = outputData.stretchGainBlue;
            pInputData->pCalculatedMetadata->stretchGainRed       = outputData.stretchGainRed;
            pInputData->pCalculatedMetadata->stretchGainGreenEven = outputData.stretchGainGreenEven;
            pInputData->pCalculatedMetadata->stretchGainGreenOdd  = outputData.stretchGainGreenOdd;
