...
VOID IFEDSX10::CalculateScalerOutput()
{
    ...
    UINT32 inputWidth  = m_pState->preCropInfo.YCrop.lastPixel - m_pState->preCropInfo.YCrop.firstPixel + 1;
    UINT32 inputHeight = m_pState->preCropInfo.YCrop.lastLine - m_pState->preCropInfo.YCrop.firstLine + 1;
