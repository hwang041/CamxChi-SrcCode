    ...
    ISPInputData* pInputData)
{
    ...
    if (IFEPipelinePath::DisplayDS4Path == m_modulePath)
    {
        ...
        CAMX_LOG_INFO(CamxLogGroupISP, "scaler [%d x %d] DS4 [%d x %d]  ",
                      m_pState->MNDSOutput.width,
                      m_pState->MNDSOutput.height,
    ...
    {
        DS4PreCropInfo* pPreCropInfo     = NULL;
            ...
            (pHALStream[DS16PortIdx].height                        != m_pState->DS16PathOutput.height))
        {
            ...
            m_pState->MNDSOutput.width      = pCalculatedScalerOutput[DS4PortIdx].dimension.width;
            m_pState->MNDSOutput.height     = pCalculatedScalerOutput[DS4PortIdx].dimension.height;
            ...
            CAMX_LOG_INFO(CamxLogGroupISP, "Stream WxH [%d x %d]",
        ...
        CAMX_LOG_INFO(CamxLogGroupISP, "scaler [%d x %d] DS16 [%d x %d]  ",
                      m_pState->MNDSOutput.width,
                      m_pState->MNDSOutput.height,
