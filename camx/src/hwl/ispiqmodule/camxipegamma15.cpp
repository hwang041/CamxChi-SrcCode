    ...
    ISPInputData* pInputData)
{
    ...
    if (CamxResultSuccess == result)
    {
        CAMX_LOG_INFO(CamxLogGroupPProc, "ISP_DBG: m_manualCCMOverride %d", m_manualCCMOverride);
        ...
        else
        {
            ...
            if (CamxResultSuccess == result)
            {
                ...
                if ((CamxLogGroupIQMod == (pInputData->dumpRegConfig & CamxLogGroupIQMod)) && (NULL != pLUT))
                {
