    ...
    VOID*                                                 pOutput)
{
        ...
        (NULL != pOutput))
    {
        ...
        if (pUnpackedField->snr_skin_y_max > pUnpackedField->snr_skin_y_min)
        {
            tempSNRSlope = IQSettingUtils::FloatToQNumber((slyMin - shyMin) /
                                                             (pUnpackedField->snr_skin_y_max - pUnpackedField->snr_skin_y_min),
                                                          QNumber_8U);
            pUnpackedField->snr_sat_min_slope = static_cast<UINT16>(IQSettingUtils::ClampUINT32(tempSNRSlope,
                                                                                                HNR10_SKIN_HUE_MAX_MIN,
                                                                                                HNR10_SKIN_HUE_MAX_MAX));
            tempSNRSlope = IQSettingUtils::FloatToQNumber((slyMax - shyMax) /
                                                             (pUnpackedField->snr_skin_y_max - pUnpackedField->snr_skin_y_min),
                                                          QNumber_8U);
            pUnpackedField->snr_sat_max_slope = static_cast<UINT16>(IQSettingUtils::ClampUINT32(tempSNRSlope,
                                                                                                HNR10_SKIN_HUE_MAX_MIN,
                                                                                                HNR10_SKIN_HUE_MAX_MAX));
        }
        else
