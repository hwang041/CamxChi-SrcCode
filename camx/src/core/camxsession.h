...
public:
    ...
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CAMX_INLINE static VOID ProcessAcquireResource(
        VOID*   pClientHandle,
        VOID*   pPrivateCallbackData)
    {
        ...
        if (NULL != pSession)
        {
            ...
            pSession->StreamOn(static_cast<CHIPIPELINEHANDLE>(pClientHandle));
        }
    }
    ...
    /// @return None
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    CAMX_INLINE static VOID ProcessReleaseResource(
        VOID*   pClientHandle,
        VOID*   pPrivateCallbackData)
    {
        ...
        {
            CAMX_LOG_INFO(CamxLogGroupCore, "session: %p, pipeline handle:%p", pSession, pClientHandle);
            pSession->StreamOff(static_cast<CHIPIPELINEHANDLE>(pClientHandle), mode);
        }
    }
