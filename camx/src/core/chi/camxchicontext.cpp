    ...
    UINT32  cameraId)
{
    ...
    if (CamxResultSuccess == result)
    {
        ...
        CAMX_ASSERT_MESSAGE(CamxResultSuccess == resultTag, "Failed to get vendor tag location for sensorModeFS");
        ...
        if (CamxResultSuccess == resultTag)
        {
            ...
            /// @note This failure means the app has failed to call get_vendor_tag_ops (HAL or CHI)
            CAMX_ASSERT_MESSAGE(CamxResultSuccess == resultTag,
                                "Failed to write vendor tag isFastShutterModeSupported to static metadata.");
        }
        ...
        CAMX_ASSERT_MESSAGE(CamxResultSuccess == resultTag, "Failed to get vendor tag location for White Balance Gains");
        if (CamxResultSuccess == resultTag)
        {
            /// @note This can be ignored becaues all standard tag set properly
            ...
            /// @note This failure means the app has failed to call get_vendor_tag_ops (HAL or CHI)
            CAMX_ASSERT_MESSAGE(CamxResultSuccess == resultTag,
                                "Failed to write vendor tag White Balance Gains to static metadata.");
        }
        ...
        CAMX_ASSERT_MESSAGE(CamxResultSuccess == resultTag, "Failed to get vendor tag location for ICA Capabilities");
        if (CamxResultSuccess == resultTag)
        {
            /// @note This can be ignored becaues all standard tag set properly
            ...
            /// @note This failure means the app has failed to call get_vendor_tag_ops (HAL or CHI)
            CAMX_ASSERT_MESSAGE(CamxResultSuccess == resultTag,
                                "Failed to write vendor tag ICA Capabilities to static metadata.");
        }
        ...
        if (CamxResultSuccess == resultTag)
        {
            ...
            /// @note This failure means the app has failed to call get_vendor_tag_ops (HAL or CHI)
            CAMX_ASSERT_MESSAGE(CamxResultSuccess == resultTag, "Failed to write vendor tag TNR to static metadata.");
        }
        ...
        if (CamxResultSuccess == resultTag)
        {
            ...
            resultTag = pStaticMetadataSlot->SetMetadataByTag(bsgcAvailableTag,
                                                              ...
                                                              "camxContext");
            CAMX_ASSERT_MESSAGE(CamxResultSuccess == resultTag,
                                "Failed to write facial attribute detection capability to static metadata.");
        }
    }
    else
    {
