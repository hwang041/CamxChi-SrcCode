                        ...
                        if (CamxResultSuccess == result)
                        {
                            ...
                            if (TRUE == callStreamOn)
                            {
                                ...
                                else
                                {
                                    ...
                                    CSLHwStreamOffKMDHardwares(hCSLHwSession, &pSession->rtList, phDevices, mode);
                ...
                if (hCSL == pSession->hSession)
                {
                    if (TRUE == CSLHwSessionGetRefCount(pSession))
                    {
                        ...
                        if (CSLInvalidHandle != *phLink)
                        {
                            ...
                            // Don't care of failure we want to make sure its always success
                            CSLHwStreamOffKMDHardwares(hCSLHwSession, pList, phDevices, mode);
