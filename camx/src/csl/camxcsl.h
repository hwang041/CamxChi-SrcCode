...
typedef enum
{
    ...
    CSLCameraTitanSocSM7450   = 425,   ///< Bitra SOC Id
} CSLCameraFamilySoc;
...
typedef enum
{
    CSLErrorMessageCodeDevice,    ///< Device has generated an error. Device errors are considered fatal to the camera session.
