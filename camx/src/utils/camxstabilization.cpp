    ...
    FLOAT               movingLinkFactor)
{
    ...
    // Check if face is moving
    FLOAT move1 = Utils::SqrtF(static_cast<FLOAT>((pLastEntry->data0 - pLastLastEntry->data0)*
        ((pLastEntry->data0 - pLastLastEntry->data0) +
        (pLastEntry->data1 - pLastLastEntry->data1)*(pLastEntry->data1 - pLastLastEntry->data1))));
    FLOAT move2 = Utils::SqrtF(static_cast<FLOAT>(((pCurrentEntry->data0 - pLastEntry->data0) *
        (pCurrentEntry->data0 - pLastEntry->data0)) +
        ((pCurrentEntry->data1 - pLastEntry->data1) *
        (pCurrentEntry->data1 - pLastEntry->data1))));
    FLOAT move3 = Utils::SqrtF(static_cast<FLOAT>(((pCurrentEntry->data0 - pLastLastEntry->data0) *
